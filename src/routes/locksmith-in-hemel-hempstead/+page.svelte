<script lang="ts">
    ...
    const city = 'Hemel-Hempstead';
    const areas: string[] = ['Hemel Hempstead', 'Berkhamsted', 'Chesham', 'Amersham', 'Chalfont St Giles', 'Beaconsfield', 'High Wycombe', 'Great Missenden', 'Aylesbury', 'Tring', 'Princes Risborough'];
</script>
