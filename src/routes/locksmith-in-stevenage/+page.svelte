<script lang="ts">
    ...
    const city = 'Stevenage';
    const areas: string[] = ['Stevenage', 'Knebworth', 'Hitchin', 'Letchworth', 'Baldock', 'Royston', 'Buntingford', 'Much Hadham', 'Ware', 'Hertford', 'Arlesey', 'Henlow', 'Shefford', 'Biggleswade', 'Sandy'];
</script>
