<script lang="ts">
    ...
    const areas: string[] = ['Birmingham', 'Alcester', 'Bromsgrove', 'Studley', 'Solihull', 'Henley-in-Arden', 'Redditch', 'Halesowen', 'Cradley Heath', 'Rowley Regis', 'Smethwick', 'Oldbury', 'West Bromwich', 'Sutton Coldfield', 'Tamworth'];
</script>
