<script lang="ts">
    ...
    const areas: string[] = ['Gloucester', 'Chipping Campden', 'Moreton-in-marsh', 'Tewkesbury', 'Dymock', 'Newent', 'Lydney', 'Cheltenham', 'Stroud', 'Cirencester', 'Tetbury', 'Stonehouse', 'Dursley', 'Berkeley', 'Wotton-under-edge', 'Badminton', 'Fairford', 'Lechlade', 'others'];
</script>

<svelte:head>
	<title>Emergency Locksmith in {city} | 24/7 Fast Local Locksmith</title>
	<meta name="description" content="Locked out in {city}? Locksmith on Call offers 24/7 emergency locksmith services with no call-out fees. Fast, reliable & local." />
