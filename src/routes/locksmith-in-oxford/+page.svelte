<script lang="ts">
    ...
    const city = 'Oxford';
    const areas: string[] = ['Oxford', 'Kidlington', 'Chipping Norton', 'Thame', 'Wallingford', 'Didcot', 'Wantage', 'Abingdon', 'Banbury', 'Woodstock', 'Bicester', 'Witney', 'Chinnor', 'Watlington', 'more'];
</script>
