<script lang="ts">
    ...
    const city = 'Southend-on-Sea';
    const areas: string[] = ['Southend-on-Sea', 'Westcliff-on-Sea', 'Rochford', 'Hockley', 'Rayleigh', 'Benfleet', 'Canvey Island', 'Leigh-on-Sea', 'Wickford', 'Basildon', 'Stanford-le-Hope'];
</script>
