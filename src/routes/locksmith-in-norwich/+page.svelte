<script lang="ts">
    ...
    const city = 'Norwich';
    const areas: string[] = ['Norwich', 'Attleborough', 'Wymondham', 'Dereham', 'Fakenham', 'Walsingham', 'Wells-next-the-Sea', 'Melton Constable', 'Holt', 'Sheringham', 'North Walsham', 'Great Yarmouth', 'Cromer', 'Lowestoft', 'Beccles', 'Bungay'];
</script>
