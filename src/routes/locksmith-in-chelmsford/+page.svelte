<script lang="ts">
    ...
    const city = 'Chelmsford';
    const areas: string[] = ['Chelmsford', 'Southminster', 'Burnham-on-Crouch', 'Ingatestone', 'Ongar', 'Dunmow', 'Braintree', 'Witham', 'Maldon', 'Billericay', 'Brentwood', 'Epping', 'Harlow', 'Sawbridgeworth', 'Bishop\'s Stortford', 'Stansted'];
</script>
