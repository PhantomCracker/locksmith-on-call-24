<script lang="ts">
    let items = [
        { text: 'MLA Certified Locksmiths', img: '/images/master-locksmiths-association.webp' },
		{ text: 'DBS Checked Technicians', img: '/images/disclosure-and-barring-service.webp' },
